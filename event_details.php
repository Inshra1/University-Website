...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<section id="event-details" class="event-details section">';
        ...
        echo '<img src="' . $row['image'] . '" class="img-fluid" alt="Event Image" style="width:100%;">';
        echo '</div>';
        
        echo '<div class="card-body">';
        echo '<h2 class="card-title text-center mt-3">' . $row['title'] . '</h2>';
        echo '<p class="text-center text-muted">' . date('F j, Y', strtotime($row['event_date'])) . '</p>';
        
        echo '<p class="card-text mt-4">' . nl2br($row['description']) . '</p>';
        echo '</div>'; 
        echo '</div>';
        echo '</div>'; 
